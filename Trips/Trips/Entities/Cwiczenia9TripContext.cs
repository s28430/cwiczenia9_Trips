...
public partial class Cwiczenia9TripContext : DbContext
{
    ...
    public Cwiczenia9TripContext()
    {
    }

    public Cwiczenia9TripContext(DbContextOptions<Cwiczenia9TripContext> options)
        : base(options)
    {
    }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=localhost,1433;Database=cwiczenia9_trip;User Id=SA;Password=VeryStr0ngP@ssw0rd;TrustServerCertificate=True");
